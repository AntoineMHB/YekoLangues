  ...
  return (
    <div className="bg-white">
      ...
      <header
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom,rgba(0,0,0,.6),rgba(0,0,0,.6)),url(${contactImage})`,
        ...
        <div className="container px-4">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-xl max-w-2xl mx-auto">
              Envie d'en savoir plus ? Besoin de conseils pour choisir votre
              cours ? Remplissez ce formulaire ou contactez-nous directement.
            </p>
          </div>
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-xl overflow-hidden">
              <form
                ...
                className="p-4 sm:p-8 text-gray-800"
              >
