...
const CTASection = () => (
  <section className="text-center mt-20 mb-20 px-4">
    <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-2xl shadow-xl p-8 md:p-12 text-white max-w-3xl mx-auto">
      ...
      <button className="bg-white text-emerald-600 font-bold py-3 px-6 md:py-4 md:px-8 rounded-full hover:bg-emerald-50 transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
      ...
      <div className="relative py-12 sm:py-24">
        ...
        <main className="relative z-10 space-y-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <>
              <p>
                YekoLangues est née du désir de partager. Partager à la diaspora
                congolaise la culture de ce grand pays qu&apos;est la République
                Démocratique du Congo.
              </p>
              <p>
                En 2025, Jacques et Antoine, deux jeunes congolais, se sont
                rendu compte que les langues locales comme le lingala et le
                swahili étaient de moins en moins pratiquées à l&apos;étranger.
              </p>
              <p>
                Alors, ils ont décidé de créer YekoLangues pour redonner vie à
                ces langues, les rendre accessibles partout dans le monde.
              </p>
            </>
          </BranchSection>
