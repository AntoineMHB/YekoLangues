    ...
    <section id="contact" className="section bg-primary-500 text-white">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="section-title text-white">Prenez contact avec nous !</h2>
        ...
        >
              ...
              <form onSubmit={handleSubmit} className="p-8 text-gray-800">
                ...
                <div className="mb-6">
                  ...
                  >
                    ...
                    <option value="course-inquiry">Renseignements sur les cours</option>
          ...
          <div className="flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">+33 6 XX XX XX XX</p>
                    <p className="mt-1 text-sm text-gray-300">
            ...
            <div className="mt-8 p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl">
              <h4 className="font-bold text-lg mb-2">Rejoignez notre communauté</h4>
              <p className="text-gray-200 mb-4">
                Suivez-nous sur les réseaux sociaux pour des astuces linguistiques, 
                des événements culturels et plus encore.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center hover:bg-opacity-30 transition-colors">
