    ...
    <section className="section bg-accent-500" id="courses">
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="relative z-[100] overflow-hidden  rounded-none transition-transform duration-500 hover:scale-110">
            <a
            ...
            <div className="relative min-h-[500px]">
              ...
              <div className="relative z-10 text-center p-6 ">
                ...
                <h5 className="mt-2 text-lg text-white/80 max-w-2xl mx-auto">
                  Parlée au cœur de l’Afrique centrale, le lingala est une
                  langue vivante et riche en culture. Apprenez à la maîtriser
                  grâce à nos cours conçus pour tous les niveaux.
                </h5>
              </div>
            </div>
          </div>

          <div className="relative z-[100] bg-black/60 hover:bg-black/20 transition-colors duration-300 rounded-none">
            <a
            ...
            <div className="relative min-h-[500px]">
              <div
                className="absolute inset-0 bg-cover bg-center
                  background-image: url('https://somalangues.com/wp-content/uploads/2024/09/AdobeStock_432905701-min.webp');"
              ></div>
              ...
              <div className="relative z-10 p-6">
                ...
                <h5 className="mt-2 text-lg text-white/80">
                  Le Swahili est l’une des langues les plus parlées en Afrique
                  de l’Est. Développez vos compétences linguistiques avec des
