  ...
  const features = [
    {
      ...
      description: "Nos cours sont adaptés à votre niveau, à votre rythme et à vos objectifs spécifiques."
    },
    {
      id: 2,
      icon: <Users className="text-white" size={28} />,
      title: "Professeurs natifs",
      description: "Apprenez auprès de locuteurs natifs qui maîtrisent la langue et la culture congolaise."
    },
    {
      id: 3,
      icon: <Globe className="text-white" size={28} />,
      title: "Immersion culturelle",
      description: "Au-delà de la langue, découvrez les traditions, les expressions et l'esprit du peuple congolais."
    },
    {
      id: 4,
      icon: <BookOpen className="text-white" size={28} />,
      title: "Communauté dynamique",
      description: "Rejoignez une communauté d'apprenants motivés et échangez avec d'autres passionnés de lingala."
    },
    {
      id: 5,
      icon: <Clock className="text-white" size={28} />,
      title: "Flexibilité",
      description: "Apprenez où et quand vous voulez grâce à nos programmes adaptés à votre emploi du temps."
    }
  ];
    ...
    <section id="why-us" className="section bg-secondary-500 text-white">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="section-title text-white">Pourquoi choisir Yekolangue ?</h2>
        </div>
